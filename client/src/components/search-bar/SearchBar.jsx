      ...
      <div className={'flex justify-around '}>
        <div className={'flex p-1'}>
          <div class="relative">
            ...
            <button type="submit" class="text-white absolute h-6 right-2.5 bottom-1 bg-slate-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-0.5 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
          </div>
        </div>
        <div onClick={() => setOpen((prev) => !prev)} className={'flex gap-x-2 p-2 text-[#fff] ml-5'}>
          ...
          {open && (
            <div 
              className={'bg-slate-700 absolute top-28  rounded-lg p-1 w-[150px] mr-2'}
            >
