...
import {
  ...
  ALL_REVIEW_SUCCESS,
  ALL_REVIEW_FAIL
} from "../../constants/product-constants/productConstants";
...
export const newReview = (reviewData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(`/api/products/review`, reviewData, config);
...
export const getAllReviews = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`/api/products/all/reviews?id=${id}`);
